...
@Component({
  ...
  template: `
    <aside #sidebar
      ...
      class="ng2e-sidebar ng2e-sidebar--{{position}}"
      [class.ng2e-sidebar--style]="defaultStyles"
    ...
    <div *ngIf="showOverlay"
      aria-hidden="true"
      class="ng2e-sidebar__overlay"
      [class.ng2e-sidebar__overlay--style]="open && defaultStyles"
